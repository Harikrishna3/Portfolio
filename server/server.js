...
app.post('/api/portfolio', (req, res) => {
    ...
    // Very basic validation - ensure it's an object
...
// 3. Simple Login for Admin Portal
app.post('/api/login', (req, res) => {
    const { password } = req.body;
    if (password === 'admin123') { // Same as dashboard for consistency
...
// Serve as static for deployment later if needed
